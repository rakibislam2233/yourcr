  ...
  return (
    <section className="relative pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 bg-linear-to-b from-primary/5 via-white to-white">
      ...
      <div className="mx-auto max-w-4xl text-center mb-10">
        <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">FAQ</h1>
      ...
      <div className="mx-auto max-w-4xl">
        <Accordion type="single" collapsible className="w-full">
          {FAQ_ITEMS.map((item) => (
            ...
            >
              <AccordionTrigger className="py-5 px-6 text-left text-lg font-medium text-gray-900 hover:no-underline">
                {item.question}
              </AccordionTrigger>
