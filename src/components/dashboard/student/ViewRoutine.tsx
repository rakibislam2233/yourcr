    ...
    <div className="space-y-6">
      ...
      <motion.div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div className="p-4 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
          ...
          <span className="text-sm text-gray-500">
            {
              Object.values(routineData[selectedDay] || {}).filter(Boolean)
                .length
            }{" "}
            classes
          </span>
              ...
              >
                ...
                {classData ? (
                  <div className="flex-1 flex items-center gap-4">
                    <div
                      className={`w-1.5 h-full min-h-[60px] ${classData.color} rounded-full`}
                    />
      ...
      <motion.div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          {days.map((day) => {
            const classCount = Object.values(routineData[day] || {}).filter(
              Boolean
            ).length;
            const isToday = day === getTodayDay();
            return (
