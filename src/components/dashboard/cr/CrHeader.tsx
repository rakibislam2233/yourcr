...
const mockNotifications = [
  {
    ...
    message: "Rahul submitted a new issue about exam schedule",
    time: "5 min ago",
    unread: true,
  },
  {
    ...
    message: "Database class starts in 30 minutes",
    time: "25 min ago",
    unread: true,
  },
  {
    ...
    message: "Mid-term exam schedule published",
    time: "1 hour ago",
    unread: false,
  },
];
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3 ml-4">
          ...
          <div className="relative">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center text-white font-semibold text-sm">
                RA
              </div>
